...
public class EmployeeController {
    ...
    public ResponseEntity<?> getOneEmployee(@PathVariable String id) {
        try {
            ...
            e.printStackTrace();
            return new ResponseEntity<>("Unable to fetch the Employee", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<?> getAllEmployees() {
        try {
            ...
            e.printStackTrace();
            return new ResponseEntity<>("Unable to fetch the Employees", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<String> updateEmployee(@RequestBody Employee employee) {
        try {
            ...
            e.printStackTrace();
            return new ResponseEntity<>("Unable to update the Employee", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<String> removeEmployee(@PathVariable String id) {
        try {
            ...
            e.printStackTrace();
            return new ResponseEntity<>("Unable to delete the Employee", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
}
